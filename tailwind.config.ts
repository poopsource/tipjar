...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      borderRadius: {
        ios: {
          sm: "var(--ios-radius-sm)",
          md: "var(--ios-radius-md)",
          lg: "var(--ios-radius-lg)",
          xl: "var(--ios-radius-xl)",
          full: "var(--ios-radius-full)",
        },
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "ios-press": "ios-press 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
      },
    },
  },
  plugins: [
